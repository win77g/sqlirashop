# Generated by Django 2.2.11 on 2020-05-31 11:33

import ckeditor_uploader.fields
import detskoePostelnoe.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default=None, null=True, upload_to=detskoePostelnoe.models.image_folder, verbose_name='Фотка')),
                ...
                ('brend', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='detskoePostelnoe.Brend', to_field='name', verbose_name='Бренд')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='DetskaPostelImage',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, default=None, null=True, upload_to=detskoePostelnoe.models.image_gallary_folder)),
                ('slug', models.SlugField(blank=True, default=None, null=True, verbose_name='Транслит')),
                ('is_main', models.BooleanField(default=False)),
                ('is_active', models.BooleanField(default=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('product', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='detskoePostelnoe.DetskaPostel')),
            ],
        ),
        migrations.AddField(
            model_name='detskapostel',
            name='tkan',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='detskoePostelnoe.Tkan', to_field='name', verbose_name='Ткань'),
        ),
    ]
