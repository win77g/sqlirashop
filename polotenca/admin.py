...
class PolotencaImageInline(admin.TabularInline):
...
# ----------------------------Product----------------------------------------------------------
# Register your models here.
class PolotencaAdmin (admin.ModelAdmin):

   inlines = [PolotencaImageInline,]
...
# Register your models here.
admin.site.register(Polotenca,PolotencaAdmin)
